...
cdag_gs = sparse_mat_cdag * vec_gs_exact2 
println(size(cdag_gs))
h_cdag_gs = sparse_mat_mom2 * cdag_gs
c_h_cdag_gs = sparse_mat_c * h_cdag_gs
println(size(c_cdag_gs))
println(size(vec_gs_exact2'))
#mom0_exact_2 = vec_gs_exact2' * c_cdag_gs
...
cdag_gs = sparse_mat_cdag * vec_gs_exact2 
println(size(cdag_gs))
h_cdag_gs = sparse_mat_mom3 * cdag_gs
c_h_cdag_gs = sparse_mat_c * h_cdag_gs
println(size(c_cdag_gs))
println(size(vec_gs_exact2'))
#mom0_exact_2 = vec_gs_exact2' * c_cdag_gs
mom3_exact_2 = dot(vec_gs_exact2, c_h_cdag_gs )
...
cdag_gs = sparse_mat_cdag * vec_gs_exact2 
println(size(cdag_gs))
h_cdag_gs = sparse_mat_mom4 * cdag_gs
c_h_cdag_gs = sparse_mat_c * h_cdag_gs
println(size(c_cdag_gs))
println(size(vec_gs_exact2'))
#mom0_exact_2 = vec_gs_exact2' * c_cdag_gs
mom4_exact_2 = dot(vec_gs_exact2, c_h_cdag_gs )
...
cdag_gs = sparse_mat_cdag * vec_gs_exact2 
println(size(cdag_gs))
h_cdag_gs = sparse_mat_mom5 * cdag_gs
c_h_cdag_gs = sparse_mat_c * h_cdag_gs
println(size(c_cdag_gs))
println(size(vec_gs_exact2'))
#mom0_exact_2 = vec_gs_exact2' * c_cdag_gs
mom5_exact_2= dot(vec_gs_exact2, c_h_cdag_gs )
