...
#debug
#N = particle number
println("Ground energy_N_ED=",minimum(enes_ed))
println("Ground_enegry_N+1_ED=", minimum(enes_ex_ed))
...
write_to_txt("gf_dimer_recurisive_vqs_test.txt", taus, Gfunc_ij_list)
println("done!!")
