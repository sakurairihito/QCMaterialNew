...
if comm !== nothing
    err_rel_mom1 = MPI.Allreduce(err_rel_mom1, MPI.SUM, comm)
    err_rel_mom1 = err_rel_mom1/MPI.Comm_size(comm)
end
...
#nshots = 2^16
#nshots = 1000
fitting_h2 = apply_qubit_ham_sampling_vqelike!(jordan_wigner(ham_op_mom), state_augmented, circuit_cdag_h2, circuit_cdag_h, nshots=nshots, dx=0.1)
...
mom2_exact_2=0.9514613093125122
err_rel_mom2 =  abs(mom2 - mom2_exact_2)/abs(mom2_exact_2)

if comm !== nothing
    err_rel_mom2 = MPI.Allreduce(err_rel_mom2, MPI.SUM, comm)
    err_rel_mom2 = err_rel_mom2/MPI.Comm_size(comm)
end
...
mom3_exact_2=1.7643790172822074
err_rel_mom3 =  abs(mom3 - mom3_exact_2)/abs(mom3_exact_2)

if comm !== nothing
    err_rel_mom3 = MPI.Allreduce(err_rel_mom3, MPI.SUM, comm)
    err_rel_mom3 = err_rel_mom3/MPI.Comm_size(comm)
end
